...
extension ScanResultsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        switch item.type {
        case .regular:
            let cell = tableView.dequeueReusableCell(withIdentifier: "RegularItemCell",
                                                     for: indexPath) as? RegularItemCell
            cell!.configure(with: item, title: title)
            cell!.hideSeparator = isLastItem
            return cell!
        case .weighted:
            let cell = tableView.dequeueReusableCell(withIdentifier: "WeightedItemCell",
                                                     for: indexPath) as? WeightedItemCell
            cell!.configure(with: item, title: title)
            cell!.hideSeparator = isLastItem
            return cell!
        }
