    ...
    required init(capturedId: CapturedId) {
        ...
        var rows = [
            ...
            SimpleTextCellProvider(
                value: barcode.cardInstanceIdentifier.valueOrNil,
            ...
            SimpleTextCellProvider(
                value: barcode.champusEffectiveDate.valueOrNil,
            ...
            SimpleTextCellProvider(
                value: barcode.civilianHealthCareFlagCode.valueOrNil,
                title: "Civilian Health Care Flag Code"
            ),
            SimpleTextCellProvider(
                value: barcode.civilianHealthCareFlagDescription.valueOrNil,
                title: "Civilian Health Care Flag Description"
            ),
            SimpleTextCellProvider(
                value: barcode.commissaryFlagCode.valueOrNil,
                title: "Commissary Flag Code"
            ),
            SimpleTextCellProvider(
                value: barcode.commissaryFlagDescription.valueOrNil,
                title: "Commissary Flag Description"
            ),
            SimpleTextCellProvider(
                value: barcode.countryOfBirth.valueOrNil,
                title: "Country Of Birth"
            ),
            SimpleTextCellProvider(
                value: barcode.countryOfBirthIso.valueOrNil,
                title: "Country Of Birth Iso"
            ),
            SimpleTextCellProvider(
                value: "\(barcode.deersDependentSuffixCode.valueOrNil)",
                title: "Deers Dependent Suffix Code"
            ),
            SimpleTextCellProvider(
                value: barcode.deersDependentSuffixDescription.valueOrNil,
                title: "Deers Dependent Suffix Description"
            ),
            SimpleTextCellProvider(
                value: barcode.directCareFlagCode.valueOrNil,
                title: "Direct Care Flag Code"
            ),
            SimpleTextCellProvider(
                value: barcode.directCareFlagDescription.valueOrNil,
                title: "Direct Care Flag Description"
            ),
            SimpleTextCellProvider(value: barcode.documentCopy.valueOrNil, title: "Document Copy"),
            SimpleTextCellProvider(
                value: barcode.documentDiscriminatorNumber.valueOrNil,
            ...
            SimpleTextCellProvider(
                value: "\(barcode.personDesignatorDocument.valueOrNil)",
                title: "Person Designator Document"
            ),
            SimpleTextCellProvider(
                value: barcode.personDesignatorTypeCode.valueOrNil,
            ...
            SimpleTextCellProvider(
                value: barcode.personalIdNumberType.valueOrNil,
                title: "Personal Id Number Type"
            ),
            SimpleTextCellProvider(
                value: barcode.personnelCategoryCode.valueOrNil,
                title: "Personnel Category Code"
            ),
            SimpleTextCellProvider(
                value: barcode.personnelEntitlementConditionType.valueOrNil,
            ...
            SimpleTextCellProvider(
                value: barcode.relationshipDescription.valueOrNil,
        ...
        if let professionalDrivingPermit = barcode.professionalDrivingPermit {
            rows.append(
                SimpleTextCellProvider(
                    value: professionalDrivingPermit.codes.joined(separator: " "),
                    title: "Professional Driving Permit - Codes"
                )
            )
            rows.append(
                SimpleTextCellProvider(
                    value: professionalDrivingPermit.dateOfExpiry.description,
