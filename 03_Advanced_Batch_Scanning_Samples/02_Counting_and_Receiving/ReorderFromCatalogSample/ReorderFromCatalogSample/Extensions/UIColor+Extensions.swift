...
extension UIColor {
    ...
    class var textColor: UIColor {
        UIColor(red: 0.07, green: 0.89, blue: 0.1, alpha: 1)
    }

    class var descriptionTextColor: UIColor {
        UIColor(red: 0.53, green: 0.58, blue: 0.63, alpha: 1)
    }

    class var sectionTextColor: UIColor {
        UIColor(red: 0.24, green: 0.28, blue: 0.32, alpha: 1)
    }

    class var shadowColor: UIColor {
        UIColor(red: 0.11, green: 0.13, blue: 0.15, alpha: 0.2)
    }
