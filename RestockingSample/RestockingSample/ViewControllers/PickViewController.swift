...
class PickViewController: UIViewController {
    ...
    private func buildSessionStore() {
        ...
        let productsToPick: Set<BarcodePickProduct> = [BarcodePickProduct(identifier: "A", quantityToPick: 1),
        ...
        pickSessionStore = PickSessionStore(productsToPick: productsToPick,
    ...
    private func setupRecognition() {
        ...
        let productProvider = BarcodePickAsyncMapperProductProvider(products: pickSessionStore.productsToPick,
                                                                    providerDelegate: self)

        // Create new Barcode Pick mode with the settings from above.
        barcodePick = BarcodePick(context: context,
                                  settings: settings,
