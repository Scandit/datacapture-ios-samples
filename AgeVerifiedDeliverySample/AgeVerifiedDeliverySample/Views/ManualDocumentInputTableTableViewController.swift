...
class ManualDocumentInputTableTableViewController: UITableViewController {
    ...
    override var preferredContentSize: CGSize {
        get {
            return CGSize(width: 375, height: 282)
        }
    ...
    func presentDatePicker(_ sender: UITextField) {
        ...
        vc.didPickDateCompletion = { [weak self] date in
...
extension ManualDocumentInputTableTableViewController: UITextFieldDelegate {
