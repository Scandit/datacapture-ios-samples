...
class MainViewController: UIViewController {
    ...
    private func makeIdCaptureViewController() -> IdCaptureViewController {
        guard
            ...
            fatalError("Could not instantiate IdCaptureViewController.")
        }
