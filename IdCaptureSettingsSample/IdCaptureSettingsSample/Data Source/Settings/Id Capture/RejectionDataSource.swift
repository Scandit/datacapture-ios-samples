...
class RejectionDataSource: DataSource {
    ...
    lazy var sections: [Section] = {
        return [Section(rows: [
            ...
            Row.action(title: "Reject IDs Expiring In Days",
                       getValue: {
...
class RejectHolderBelowAgeTableViewController: SettingsTableViewController {
    ...
    override func setupDataSource() {
        dataSource = OptionalNumberDataSource(delegate: self,
