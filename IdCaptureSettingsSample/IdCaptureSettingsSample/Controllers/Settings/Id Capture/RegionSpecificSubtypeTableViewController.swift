...
class RegionSpecificSubtypeTableViewController: SearchingSettingsTableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        allNoneButtonItem = UIBarButtonItem(title: buttonTitle(), style: .plain,
                                            target: self, action: #selector(allNoneTapped))
    ...
    override func setupDataSource() {
        dataSource = RegionSpecificSubtypeDataSource(delegate: self,
                                                     keyPath: keyPath,
